...
describe("Get Account", () => {
  ...
  it("should be able to create a delete Account", async () => {
    const usecase = new GetExtractByDataUseCase(
      createAccountRepo,
  ...
  it("should not be able to delete Account, if account not exist", async () => {
    ...
    await expect(
      usecase.execute("42845684002", "2022-05-24", "2022-05-27")
  ...
  it("should not be able to Withdraw Account, if startDate is invalid", async () => {
    ...
    await expect(
      usecase.execute("42845684002", "2022-05-32", "2022-05-27")
    ).rejects.toEqual(mockError);
  });
  ...
  it("should not be able to Withdraw Account, if endDate is invalid", async () => {
    ...
    await expect(
      usecase.execute("42845684002", "2022-05-28", "2022-05-32")
    ).rejects.toEqual(mockError);
  });
});
